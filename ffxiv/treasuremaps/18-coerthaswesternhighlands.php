...
<body>
	<div class="mapdiv">
		...
		<div class="mapimg">
			<img id="hunt_map" src="../images/hw/cwh.jpg">
			<img id="hunt_i" src="../images/hw/cwhtmi.png">
			<img id="hunt_s" src="../images/hw/cwhg8.png">
			<img id="hunt_a1" src="../images/hw/cwhg7.png">
			<img id="hunt_a2" src="../images/hw/cwhg6.png">
		</div>
	</div>
</body>
</html>