...
<body>
	<div class="mapdiv">
		...
		<div class="mapimg">
			<img id="hunt_map" src="../images/hw/tdf.jpg">
			<img id="hunt_i" src="../images/hw/tdftmi.png">
			<img id="hunt_s" src="../images/hw/tdfg8.png">
			<img id="hunt_a1" src="../images/hw/tdfg7.png">
			<img id="hunt_a2" src="../images/hw/tdfg6.png">
		</div>
	</div>
</body>
</html>