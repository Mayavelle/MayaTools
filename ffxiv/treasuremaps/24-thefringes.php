...
<body>
	<div class="mapdiv">
		...
		<div class="mapimg">
			<img id="hunt_map" src="../images/sb/fringes.jpg">
			<img id="hunt_i" src="../images/sb/fringestmi.png">
			<img id="hunt_s" src="../images/sb/fringesg10.png">
			<img id="hunt_a1" src="../images/sb/fringesg9.png">
		</div>
	</div>
</body>
</html>