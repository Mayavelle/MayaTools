...
<body>
	<div class="mapdiv">
		...
		<div class="mapimg">
			<img id="hunt_map" src="../images/sh/kholusia.jpg">
			<img id="hunt_i" src="../images/sh/kholusiatmi.png">
			<img id="treasure_s" src="../images/sh/kholusiag12.png?version=1">
			<img id="treasure_simages" src="../images/sh/kholusiag12images.png?version=1">
			<img id="treasure_a1" src="../images/sh/kholusiag11.png?version=1">
			<img id="treasure_a1images" src="../images/sh/kholusiag11images.png?version=1">
		</div>
	</div>
</body>
</html>